export const BROWSE_CATEGORIES = [
  ...
  { name: 'Ambient & Atmospheric', gradient: 'from-indigo-600 via-purple-600 to-pink-500', icon: 'Sparkles' },
  ...
  { name: 'Popular on VERTEX', gradient: 'from-fuchsia-600 via-purple-700 to-pink-600', icon: 'Compass' },
] as const;
